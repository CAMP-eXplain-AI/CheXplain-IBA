...
class SensitivityN(BaseEvaluation):
    ...
    def __init__(self, regression_model, img_size, n, num_masks=100):
        self.regression_model = regression_model
        self.n = n
        self.device = next(self.regression_model.parameters()).device
    ...
    def evaluate(   # noqa
        ...
        with torch.no_grad():
            ...
            output = self.regression_model(input_imgs)
